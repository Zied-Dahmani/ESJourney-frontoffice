    ...
    return Stack(
      ...
      children: [
          ...
          children: [
            Padding(
              padding: EdgeInsets.only(
                  top: (20 + MediaQuery.of(context).padding.top) * (1 - bottomPercent),
            ...
            Positioned(
              top: lerpDouble(-100, 140, topPercent)!.clamp(MediaQuery.of(context).padding.top + 11, 140.0),
        ...
        Positioned.fill(
            ...
            child: TranslateAnimation(child: TimerCountdownContainer(deadline: club.deadline))),
        Align(
