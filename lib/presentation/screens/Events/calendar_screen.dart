...
class _CalendarScreenState extends State<CalendarScreen> {
  ...
  Future<void> _onRefresh() async {
    ...
    if (userState is UserLogInSuccess) {
      ...
      await _fetchEvents(userState.user.token);
    }
  ...
  Future<void> _fetchEvents(String token) async {
    final userState = context.read<UserCubit>().state;
    if (userState is UserLogInSuccess) {
      final eventsState = context.read<EventCubit>().state;
      if (eventsState is EventSuccess) {
        final getEvents = BlocProvider.of<EventCubit>(context);
        await getEvents.getUserEvents(token);
      }
    }
  }
