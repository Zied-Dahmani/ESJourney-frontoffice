...
class _MyEventsScreenState extends State<MyEventsScreen> {
  ...
  void _initializeLabeler() async {
    ...
    // Make sure to add the TFLite model to assets/ml directory
    const assetPath = 'assets/model_unquant.tflite';
    ...
    // Make sure to add the model to Firebase ML Kit console
...
class MyEventsScreen extends StatefulWidget {
  MyEventsScreen({Key? key, this.title}) : super(key: key);
