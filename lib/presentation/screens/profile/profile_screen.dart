  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: theme.colorScheme.primary,
      ...
      body: BlocBuilder<UserCubit, UserState>(builder: (context, state) {
        if (state is UserLoadInProgress) {} else if (state is UserLogInSuccess) {
          ...
          return Column(children: [
            Expanded(child: Stack(children: [
              CustomContainer(width: width,
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Center(child: Text(
                      "userx", style: theme.textTheme.headlineMedium,),),
                    Container(width: width,
                      margin: const EdgeInsets.only(
                          left: 20.0, right: 20.0, top: 20.0),
                      decoration: BoxDecoration(color: Colors.white,
                        boxShadow: const [
                          BoxShadow(color: // custom color hex code
                          Color(0xFFE7E7E7),
                          ...
                          children: [
                            ...
                            SizedBox(height: width * 0.13,
                              child: VerticalDivider(
                                color: Colors.grey[100], thickness: 1,),),
                            const ProfileContainer(
                    ...
                    Container(margin: const EdgeInsets.only(
                        ...
                        child: const Text("Badges (2)", style: TextStyle(
                          color: Colors.black,
                          fontSize: 17,
                    ...
                    Container(margin: const EdgeInsets.only(left: 10.0),
                      child: Row(children: [
                        SvgPicture.asset(
                          ...
                          height: width * 0.15,),
                        SvgPicture.asset('assets/icons/challenges/trophy.svg',
                          height: width * 0.15,),
                        SvgPicture.asset(
              ...
              Positioned(
                top: 0, left: 0, right: 0, child: Center(child: SizedBox(
                height: width * 0.27, width: width * 0.25,
                ...
                child: Stack(children: [
                  ...
                  Align(alignment: Alignment.bottomCenter,
                    child: SvgPicture.network(height: width * 0.05,
          ...
          return const Center(child: Text('Something went wroddng!'),);
        }
        return const Center(child: Text('Something went wrddong!'),);
      },
...
class CustomContainer extends StatelessWidget {
  const CustomContainer(
      {super.key, required this.width, required this.backgroundColor, this.child, this.margin = const EdgeInsets
          .only(left: 5.0, right: 5.0, top: 60.0),});
